...
const formatApiUser = (rawUser, overviewData = null) => {
  ...
  return {
    ...
    personalVolume: Number(overviewData?.personalVolume ?? rawUser?.personalVolume ?? overviewData?.wallets?.personalVolume ?? 0),
    groupVolume: Number(overviewData?.groupVolume ?? rawUser?.groupVolume ?? overviewData?.wallets?.groupVolume ?? 0),
    nextSettlementTime: overviewData?.streaming?.nextSettlementTime || rawUser?.nextSettlementTime || null,
    settlementStartTime: overviewData?.streaming?.settlementStartTime || rawUser?.settlementStartTime || null,
