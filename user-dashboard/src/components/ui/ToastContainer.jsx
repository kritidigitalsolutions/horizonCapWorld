    ...
    >
      {toasts.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className={`pointer-events-auto relative overflow-hidden rounded-2xl border ${style.border} ${style.bg} p-4 transition-all duration-300 transform animate-slide-in-right flex items-start gap-3.5`}
            style={{
