...
export default function Notifications() {
  ...
  return (
    <div className="space-y-6 animate-fade-in font-poppins pb-12">
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6">
        ...
        <div className="relative z-10 space-y-1.5">
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold font-display text-white tracking-tight">
            Notification Center
          </h1>
        ...
        <div className="relative z-10 flex items-center gap-3 self-end md:self-center">
          <button
            onClick={fetchAlerts}
            className="p-2.5 sm:p-3 bg-slate-800/80 hover:bg-slate-700 text-slate-300 rounded-2xl border border-slate-700 transition-colors cursor-pointer"
            title="Refresh Feed"
          >
      ...
      {/* Main Container Card */}
      <div className="card p-3.5 sm:p-6 border border-slate-100 shadow-card space-y-4 sm:space-y-5">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-3.5 pb-4 border-b border-slate-100">
            ...
            {CATEGORY_TABS.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all flex items-center gap-1.5 cursor-pointer flex-shrink-0 ${
                    isActive
          ...
          <div className="flex items-center gap-2 flex-wrap w-full xl:w-auto">
            ...
            {unreadCount > 0 && (
              ...
              >
                <RiCheckAll size={15} /> <span>Mark All Read</span>
              </button>
            )}
            ...
            {notifications.length > 0 && (
              ...
              >
                <RiTrash size={15} /> <span>Clear All</span>
              </button>
            )}
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start gap-3 sm:gap-3.5 flex-1 min-w-0">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 border shadow-2xs ${cfg.bg}`}>
                      <Icon size={18} />
                    </div>
